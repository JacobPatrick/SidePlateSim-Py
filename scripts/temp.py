...
from interface.type import GearProfileDir, SidePlateState, FilmParam, FluidProp, Pressure, SidePlateMassProp, ForceTorque
...
def one_step_pipeline(t, dt, omega, oil_mu, side_plate_mass_prop: SidePlateMassProp, prev_status):
    # 1. 集中参数法求齿腔压力
    mock_lpm = MockLPM()
...
def main():
    ...
    side_plate_mass_prop = SidePlateMassProp(m=m, barycenter=barycenter, Ic=Ic, g_vec=g_vec)
